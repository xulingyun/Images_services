...
$(function() {
	datagrid = $('#dg').datagrid({
		url:"<%=root%>/imageTextServlet?method=getdata",
		method:'post',
		pageSize:50,
		fit: true,
		toolbar:"#tb",
		...
		columns : [ [ 
	        ...
	        onDblClickRow:function(rowIndex, rowData){
	        	var imgStr = "<img src=/weixinImage/"+rowData['cover']+" width='100' height='100'></img>";
...
function accept(){
	editDialog("修改图文消息","#edit_from",datagrid,"single.jsp",350,230);
}
